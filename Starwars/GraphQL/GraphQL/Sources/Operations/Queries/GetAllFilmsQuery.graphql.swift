...
public class GetAllFilmsQuery: GraphQLQuery {
    ...
    public struct AllFilms: GraphQL.SelectionSet {
      ...
      public struct Film: GraphQL.SelectionSet {
        ...
        public struct SpeciesConnection: GraphQL.SelectionSet {
          ...
          public static var __parentType: ApolloAPI.ParentType { GraphQL.Objects.FilmSpeciesConnection }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
          ...
          public struct Specy: GraphQL.SelectionSet {
            ...
            public static var __parentType: ApolloAPI.ParentType { GraphQL.Objects.Species }
            public static var __selections: [ApolloAPI.Selection] { [
              .field("__typename", String.self),
            ...
            public struct Homeworld: GraphQL.SelectionSet {
              ...
              public static var __parentType: ApolloAPI.ParentType { GraphQL.Objects.Planet }
              public static var __selections: [ApolloAPI.Selection] { [
                .field("__typename", String.self),
                .field("name", String?.self),
              ] }
